...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "group relative inline-flex items-center justify-center px-8 py-3.5 text-sm font-semibold tracking-wide transition-all duration-300 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer";
